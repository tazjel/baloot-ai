...
class FullGameScenario(TestScenario):
...
class BiddingTestScenario(TestScenario):
...
class ProjectTestScenario(TestScenario):
...
class SawaTestScenario(TestScenario):
...
class DoubleTestScenario(TestScenario):
